...
*If you encounter an error, ensure that the MongoDB server is running.* See [Install MongoDB](#2-install-mongodb) for instructions on how to start the MongoDB server after installation.
